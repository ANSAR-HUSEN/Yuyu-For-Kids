...
import { 
  ...
  Shield, Gift, Sparkles, Baby, Smile
} from 'lucide-react';
...
const ParentDashboard = () => {
  ...
  const children = [
    { id: 1, name: "Hany", age: 7, pin: "1234", xp: 1234, level: 5, streak: 7 },
    { id: 2, name: "Emma", age: 5, pin: "5678", xp: 890, level: 3, streak: 4 }
  ];
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {children.map((child, idx) => {
                  const AvatarIcon = childAvatars[idx % childAvatars.length];
                  return (
                    <motion.div
                      key={child.id}
                      whileHover={{ y: -5 }}
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex gap-2">
                          <button className="p-2 rounded-full hover:bg-softPink/20 transition-colors">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-lg border border-peach max-w-2xl">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pb-3 border-b border-peach">
                    <div>
                      <p className="font-bold text-darkBrown">Password</p>
                      <p className="text-sm text-warmBrown">••••••••</p>
                    </div>
                    <button className="text-softPink text-sm font-bold">Reset</button>
                  </div>
